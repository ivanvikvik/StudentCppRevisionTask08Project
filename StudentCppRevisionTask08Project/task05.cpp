 ...
 *	2) Для определения високосности года можно воспользоваться уже разработанным алгоритмом.
 *	3) Не забудьте про "защиту от дурака": если номер месяца некорректен, то нужно возвратить 0.
 *
